...
class ApiDocExtractor
{
    ...
    public function __construct(ContainerInterface $container, RouterInterface $router, Reader $reader, DocCommentExtractor $commentExtractor, iterable $handlers, array $annotationsProviders)
    {
